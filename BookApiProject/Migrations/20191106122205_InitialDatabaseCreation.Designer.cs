...
namespace BookApiProject.Migrations
{
    ...
    [Migration("20191106122205_InitialDatabaseCreation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookApiProject.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BookApiProject.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BookApiProject.Reviewer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BookApiProject.Models.BookAuthor", b =>
                {
                    b.HasOne("BookApiProject.Author", "Author")
                        .WithMany("BookAuthors")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BookApiProject.Book", "Book")
                        .WithMany("BookAuthors")
            ...
            modelBuilder.Entity("BookApiProject.Models.Review", b =>
                {
                    ...
                    b.HasOne("BookApiProject.Reviewer", "Reviewer")
                        .WithMany("Reviews")
